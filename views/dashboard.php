					...
					<div class="row-fluid">
						<div class="span2 action-nav-button">
				          ...
				          <div class="span2 action-nav-button">
								...
								<span class="label label-total"> T:15</span>	
								<span class="label-active label-total"> A:15</span>
								</a>							
							</div>
				...
				<div class="box-content scrollable" style="max-height: 500px; overflow-y: auto">
					...
					<script type="text/javascript">
					  ...
					  function drawChart() {
						...
						// Set chart options
						var options = {'title':'Chart depicting number of students in each category', 'width':450,'height':300};
				...
				<div class="box-content scrollable" style="max-height: 500px; overflow-y: auto">
					...
					<script type="text/javascript">
					  ...
					  function drawChart() {
						...
						// Set chart options
						var options = {'title':'Chart depicting exams taken up by students in last 7 days', 'width':450,'height':300};
